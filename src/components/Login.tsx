...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-primary-50/20 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md animate-fade-in space-y-8">
        ...
        {error && (
          <div className="animate-fade-in-down rounded-lg border border-red-200 bg-red-50 p-4 shadow-sm">
            <div className="flex">
              <div className="ml-3">
        ...
        <form
          className="mt-8 space-y-6 rounded-2xl bg-white p-8 shadow-soft"
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="relative block w-full appearance-none rounded-lg border border-gray-300 px-4 py-3 text-gray-900 transition-all duration-200 placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 sm:text-sm"
